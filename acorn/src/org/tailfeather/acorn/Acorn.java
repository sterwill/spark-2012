...
public class Acorn {
	...
	// try {
	// line =
	// Console.readLine(Resources.getMessage("org/tailfeather/acorn/main-prompt.txt"),
	...
	// break;
	// default:
	// printErrorLine(MessageFormat.format("Unrecognized command ''{0}'', please try again",
	// tokens[0]));
	// break;
	// }
	// }
	...
	// try {
	// line =
	// Console.readLine(Resources.getMessage("org/tailfeather/acorn/register-verify-prompt.txt"),
	...
	// String line;
	// try {
	// line = Console.readLine(prompt, REGISTER_PROMPT_TIMEOUT_SECONDS,
	// TimeUnit.SECONDS);
	// } catch (InterruptedException e) {
	// LOGGER.log(Level.WARNING, "Interrupted while prompting for register", e);
	// continue;
